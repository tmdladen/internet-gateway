...
```bash
curl -sS [https://raw.githubusercontent.com/DeupGaming/net-way-setup/main/setup.sh](https://raw.githubusercontent.com/DeupGaming/net-way-setup/main/setup.sh) | sudo bash
...
```bash
GOST_URL="wss://user:pass@your-server.com:443" curl -sS [https://raw.githubusercontent.com/DeupGaming/net-way-setup/main/setup.sh](https://raw.githubusercontent.com/DeupGaming/net-way-setup/main/setup.sh) | sudo bash
...
```bash
curl -sS [https://raw.githubusercontent.com/DeupGaming/net-way-setup/main/inner-vm-proxy.sh](https://raw.githubusercontent.com/DeupGaming/net-way-setup/main/inner-vm-proxy.sh) | sudo bash
...
```bash
curl -sS [https://raw.githubusercontent.com/DeupGaming/net-way-setup/main/inner-vm-setup.sh](https://raw.githubusercontent.com/DeupGaming/net-way-setup/main/inner-vm-setup.sh) | sudo bash
...
```bash
curl -x [http://127.0.0.1:8796](http://127.0.0.1:8796) [https://ifconfig.me](https://ifconfig.me)
